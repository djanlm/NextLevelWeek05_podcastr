...
import Slider from 'rc-slider'; //biblioteca pra o slider
...
export function Player() {
  ...
  useEffect(() => {
    ...
    if (!audioRef.current) { // se tiver nulo
      return;
    }
  ...
  function setUpPorgressListener() {
      ...
      <footer className={!episode ? styles.empty : ''}>
        ...
        {episode && (
          <audio
            ...
            onLoadedMetadata={setUpPorgressListener}
